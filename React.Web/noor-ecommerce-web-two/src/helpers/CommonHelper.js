...
export const GetDefaultCurrencySymbol = () => {
    let DefaultCurrencySymbol = "£";  //--GBP is consider as default if there is no setting in appsetting.json file
...
export const GetDefaultCurrencyCode = () => {
    let DefaultCurrencyCode = "GBP";  //--GBP is consider as default if there is no setting in appsetting.json file
    DefaultCurrencyCode = Config.APP_SETTING['DefaultCurrencyCode'] ?? "GBP";
