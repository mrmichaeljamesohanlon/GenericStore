...
const MenuBar = (props) => {
    ...
    const navLinkClass = ({ isActive }) => `dark-menu-item has-submenu${isActive ? ' active' : ''}`;
    ...
    return (
        <>
            ...
            <li>
                ...
                <NavLink to={`/${getLanguageCodeFromSession()}/`} end className={navLinkClass} id="lbl_mgmenu_home">
            ...
            <li>
                ...
                <NavLink to={`/${getLanguageCodeFromSession()}/contact-us`} id="lbl_thead_contct" className={navLinkClass}>
            ...
            <li>
                ...
                <NavLink to={`/${getLanguageCodeFromSession()}/faq`} id="lbl_thead_faq" className={navLinkClass}>
            ...
            <li>
                ...
                <NavLink to={`/${getLanguageCodeFromSession()}/about`} className={navLinkClass} id="lbl_thead_about">
                    {LocalizationLabelsArray.length > 0 ?
