...
import { makeImageUrl, makeProductShortDescription } from '../../../../helpers/ConversionHelper';
                                        ...
                                        wishListData.map((item, index) => {
                                            return (
                                                <li key={index}>
                                                    <div className="media">
                                                        <a href="#">
                                                            <Media alt="" className="me-3" src={item.DefaultImage != undefined ? makeImageUrl(adminPanelBaseURL, item.DefaultImage) : ""} />
                                                        </a>
