    ...
    useEffect(() => {
        ...
        const GetFiltersAllValues = async () => {
            ...
            if (categoriesResponse != null && categoriesResponse.data != null) {
                ...
                setCategoriesList([...uniqueCategories].sort((a, b) => (a.Name ?? '').localeCompare(b.Name ?? '')));
                            ...
                            <div className="media">
                                {
                                    item?.ProductImagesJson?.slice(0, 1).map((img, imgIdx) =>
                                        ...
                                        >
                                            <Media className="img-fluid " src={makeImageUrl(adminPanelBaseURL, img.AttachmentURL)} alt="" />
                                        </Link>
