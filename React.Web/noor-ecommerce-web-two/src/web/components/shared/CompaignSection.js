...
import { makeAnyStringLengthShort, makeImageUrl } from "../../../helpers/ConversionHelper";
                        ...
                        <Col md="4" key={i}>
                            <div className="collection-banner-main banner-1 p-left">
                                <div className="collection-img">
                                    <Media src={makeImageUrl(adminPanelBaseURL, item.CoverPictureUrl)} className="img-fluid bg-img " alt="banner" />
                                </div>
