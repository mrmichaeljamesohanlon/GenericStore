...
import { convertDateToDifferentFormats, getFileExtensionFromContentType, makeImageUrl, makeProductShortDescription, replaceWhiteSpacesWithDashSymbolInUrl } from '../../../helpers/ConversionHelper';
                                        ...
                                        <tbody>
                                            ...
                                            {OrderItemsDetailList?.map((itemDetail, idx) => (
                                                <tr key={idx}>
                                                    <td>
                                                        <a href="#">
                                                            <Media src={makeImageUrl(adminPanelBaseURL, itemDetail.DefaultImageUrl)} alt="product" className="img-fluid" />
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="#">
