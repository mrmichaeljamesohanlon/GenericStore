                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-12">
                            <div className="about-image">
                                <img src={makeImageUrl(adminPanelBaseURL, CampaignDetail.CoverPictureUrl)} className="about-img1" alt="image" />
                                ...
                                <Row className="blog-media">
                                    <Col xl="6">
                                        <div className="blog-left">
                                            <a href="#">
                                                <Media src={makeImageUrl(adminPanelBaseURL, CampaignDetail.CoverPictureUrl)} className="img-fluid" alt="" />
                                            </a>
