...
import { getSanitizedCartItems } from '../../../helpers/CartHelper';
...
const Checkout = () => {
    ...
    useEffect(() => {
        ...
        const dataOperationInUseEffect = async () => {
            ...
            const stripeP = await GetLoadSTRPPublishable(Config.END_POINT_NAMES['GET_STRP_PUB_KEY'], Config['COMMON_CONTROLLER_SUB_URL'], paramStripe, headers);
            if (stripeP == null) {
                showErrorMsg('Unable to load payment processor. Please refresh the page and try again.');
            }
