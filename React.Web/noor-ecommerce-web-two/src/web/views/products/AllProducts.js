...
const AllProducts = () => {
    ...
    let categParamArray = [];
    const parsedCategoryId = parseInt(params.category_id, 10);
    if (!Number.isNaN(parsedCategoryId) && parsedCategoryId > 0) {
        categParamArray.push(parsedCategoryId);
    }
    ...
    const setFilterValueInParent = async (e, value, type) => {
        ...
        await getAllProductsAfterAnyFilterChange(1, categoriesIdsCommaSeperated, minPriceLocal, maxPriceLocal, ratingLocal, tagsIdsCommaSeperated, colorIdLocal, null);
    ...
    const setPageSizeFromProductFilter = async (e) => {
        ...
        await getAllProductsAfterAnyFilterChange(1, null, null, null, null, null, null, null);
    ...
    const setSortByFilter = async (e) => {
        ...
        await getAllProductsAfterAnyFilterChange(1, null, null, null, null, null, null, e.target.value);
    ...
    const setCurrentPage = async (pageNumber) => {
        ...
        setTimeout(async () => {
            await getAllProductsAfterAnyFilterChange(pageNumber, null, null, null, null, null, null, null);
        }, 200);
    ...
    const getAllProductsAfterAnyFilterChange = async (pageNumber, _categoryId,
