...
import { AddCustomerWishList, AddProductToCart, getSanitizedCartItems } from "../../../helpers/CartHelper";
...
const ProductDetail = () => {
    ...
    const HandleAddToCart = (isBuyNowBtn) => {
        ...
        dispatch(rootAction.cartAction.SetTotalCartItems(getSanitizedCartItems(cartItems).length));
