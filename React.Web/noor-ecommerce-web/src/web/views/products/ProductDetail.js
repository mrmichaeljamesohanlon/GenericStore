...
import { makeImageUrl, makePriceRoundToTwoPlaces, makeProductShortDescription, setProductDescriptionImagesUrl } from '../../../helpers/ConversionHelper';
                                    ...
                                    <div className="payment-methods">
...

                                        {
                                            paymentMethods?.map((item, idx) =>
                                                ...
                                                <Link to="#">
                                                    <img src={makeImageUrl(adminPanelBaseURL, item.ImageUrl)} alt="image" />
                                                </Link>
                                        ...
                                        <div className="tab_content">
                                            ...
                                            <div id="tab4" className="tabs_item">
                                                <div className="products-details-tab-content">
                                                    ...
                                                    <ol>
                                                        <li>Professional, friendly service with a no-nonsense approach.</li>
                                                        <li>Transparent and trustworthy – no hidden costs, ever.</li>
                                                        <li>We treat your purchase with the same care as our own.</li>
                                                        <li>If we say we'll do something, we'll do it.</li>
                                                        <li>Secure, fast checkout and delivery across the UK.</li>
                                                    </ol>
                                                </div>
                                            </div>
