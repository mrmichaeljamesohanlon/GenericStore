...
import { makeImageUrl, makePriceRoundToTwoPlaces, makeProductShortDescription } from '../../../helpers/ConversionHelper';
                                                        ...
                                                        {cartProductsData?.map((item, idx) => (
                                                            <tr key={idx}>
                                                                <td className="product-thumbnail">
                                                                    <Link to="#">
                                                                        <img src={item.ProductImagesJson?.[0]?.AttachmentURL != undefined ? makeImageUrl(adminPanelBaseURL, item.ProductImagesJson?.[0]?.AttachmentURL) : ""} alt="image" />
                                                                    </Link>
                                                                </td>
