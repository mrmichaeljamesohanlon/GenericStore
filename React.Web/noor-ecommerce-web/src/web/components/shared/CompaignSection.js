...
import { makeAnyStringLengthShort, makeImageUrl, makeProductShortDescription } from '../../../helpers/ConversionHelper';
                                    ...
                                    CampaignList?.map((item, idx) =>
                                        ...
                                        <div className="col-lg-3 col-sm-6">
                                            <div className="offer-categories-box left-categories hover-active">
                                                <img src={makeImageUrl(adminPanelBaseURL, item.CoverPictureUrl)} alt="image" height={190}/>
