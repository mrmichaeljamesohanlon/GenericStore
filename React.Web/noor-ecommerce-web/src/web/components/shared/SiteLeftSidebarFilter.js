...
import { makeAnyStringLengthShort, makeImageUrl, makeProductShortDescription, replaceWhiteSpacesWithDashSymbolInUrl } from '../../../helpers/ConversionHelper';
                                ...
                                <Link to="#">
...

                                    {
                                        item?.ProductImagesJson?.slice(0, 1).map((img, imgIdx) =>
                                            <>
                                                <img src={makeImageUrl(adminPanelBaseURL, img.AttachmentURL)} alt="image" />
