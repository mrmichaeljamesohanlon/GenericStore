...
import { makeProductShortDescription, replaceWhiteSpacesWithDashSymbolInUrl, makeImageUrl } from '../../../helpers/ConversionHelper';
                                            ...
                                            <Link to={urlViewDetailImage} onClick={() => reloadProductDetail(item.ProductId, item.CategoryName, item.ProductName)}>

                                                {
                                                    item?.ProductImagesJson?.map((img, imgIdx) =>
                                                        <>
                                                            <img src={makeImageUrl(adminPanelBaseURL, img.AttachmentURL)} alt="image" key={imgIdx}/>
