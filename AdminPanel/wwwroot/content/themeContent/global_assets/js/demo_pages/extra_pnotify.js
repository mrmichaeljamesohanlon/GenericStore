...
var Pnotify = function () {
    ...
    var _componentPnotify = function () {
        ...
        function show_success_error_msg_site() {

            // Get data values of button "#success-error-msg-hidden-btn". This button is defined in _HiddenHtmlFields.cshtml partial view
            let type = $('#success-error-msg-hidden-btn').attr("data_msg_type");
            let title = $('#success-error-msg-hidden-btn').attr("data_msg_title");
            let text = $('#success-error-msg-hidden-btn').attr("data_msg_text");
            ...
            switch (type) {
                case 'error':
                    opts.title = title;
                    opts.text = text;
                    opts.addclass = "stack-bottom-right alert alert-warning alert-styled-left";
                    opts.type = "error";
                    break;
                ...
                case 'info':
                    opts.title = title;
                    opts.text = text;
                    opts.addclass = "stack-bottom-right alert alert-info alert-styled-left";
                    opts.type = "info";
                    break;
                ...
                case 'success':
                    opts.title = title;
                    opts.text = text;
                    opts.addclass = "stack-bottom-right alert alert-success alert-styled-left";
                    opts.type = "success";
                    break;
            }
            new PNotify(opts);
        ...
        // Custom bottom
        $('#success-error-msg-hidden-btn').on('click', function () {
            show_success_error_msg_site();
        });
